...
--[[
  This library has been modified my: Mike Lyons 1/21/2022
  Uncertain of the reason but string.char was breaking like 114 ()
]]
...
function tbox:keypressed(key, unicode)
	...
	elseif key:len() == 1 then --it's a single letter
		self.text = self.text..(unicode or key) -- string.char(unicode)
		-- self.text = self.text..string.char(unicode) -- this was borken and erroring out
