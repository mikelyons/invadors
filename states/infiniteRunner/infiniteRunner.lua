--[[
  ...
  a infiniteRunner for adding a new gamestate
]]

print('infiniteRunner.lua -> ')
print('infiniteRunner -> ')
...
local Signin = Game:addState('infiniteRunner')
...
function Signin:enteredState()
  if DEBUG_LOGGING_ON then
    print(string.format("ENTER infiniteRunner STATE - %s \n", os.date()))
  end
end
